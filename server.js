...
const DOKU_CREATE_VA_PATH       = process.env.DOKU_CREATE_VA_PATH || '/bi-snap-va/v1/transfer-va/create-va';
...
async function createDokuPaymentLink(accessToken, orderData) {
    ...
    if (apiType === 'checkout') {
        ...
        // ═══ SNAP BI Direct: HMAC-SHA512 per official DOKU SNAP spec ═══
        // Colon-separated, lowercase hex bodyHash
